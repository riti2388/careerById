            ...
            <div className="flex items-start gap-[30px] w-full">
              <nav className="flex flex-col items-start gap-[11px] flex-1">
                ...
                {quickLinks.map((link, index) => (
                  ...
                  >
                    <span className="text-neutralwhite text-base leading-[22px] whitespace-nowrap [font-family:'Nunito_Sans',Helvetica] font-normal tracking-[0] hover:underline">
                      {link}
                    </span>
                  </a>
                ))}
              ...
              <nav className="flex flex-col items-start gap-[11px] flex-1">
                ...
                {services.map((service, index) => (
                  <a
                    ...
                    className="flex items-center gap-2.5 w-full"
                  >
                    <span className="text-neutralwhite leading-[22px] whitespace-nowrap [font-family:'Nunito_Sans',Helvetica] font-normal text-base tracking-[0] hover:underline">
                      {service}
                    </span>
                  </a>
                ))}
