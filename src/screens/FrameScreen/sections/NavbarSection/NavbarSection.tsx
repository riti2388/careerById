    ...
    <nav className="flex h-[94px] items-center gap-[30px] px-[135px] py-5 w-full bg-white shadow-[0px_4px_14px_#0000000a]">
      ...
      <div className="flex items-start justify-center gap-[30px] flex-1">
        {navItems.map((item, index) => (
          <div
            key={index}
            className="inline-flex flex-col items-center justify-center gap-px cursor-pointer"
          >
            <div
      ...
      <div className="relative w-[230.15px] h-[54px]">
        ...
        >
          <span className="flex items-center justify-center w-fit mt-[-1.50px] [font-family:'Nunito_Sans',Helvetica] font-medium text-neutralgray-700 text-lg text-center tracking-[0] leading-[26px] whitespace-nowrap">
            Free Consultation
          </span>
        </Button>
